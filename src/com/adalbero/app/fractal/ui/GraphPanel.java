...
public class GraphPanel extends Panel {
	...
	private Image image;
	private IterationDialog dialog;

	private List<Complex> iterations;
	...
	public GraphPanel(IterationDialog dialog) {
		this.dialog = dialog;
	...
	private void setMessage(int it, double value) {
		dialog.setMessage(it, value);
	}
	...
	public void paint(Graphics g) {
		...
		if (focus >= 0) {
			...
			if (focus < iterations.size()) {
				String str = iterations.get(focus).format(true);
	...
	public void setGraph(List<Complex> iterations, double tolerance, List<Complex> roots) {
